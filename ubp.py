...
def displayBarPassage(streamlit_tab,selected_schools):
    ...
    streamlit_tab.plotly_chart(ubp_fig,use_container_width=True)
    ...
    col1.plotly_chart(ftbp_fig,use_container_width=True)
    col2.plotly_chart(state_diff,use_container_width=True)
